namespace Mvc4Sample.Infrastructure.NHibernate
{
    ...
    public class NHibernateInitializer : INHibernateInitializer
    {
        public Configuration GetConfiguration()
        {
            ...
            AutoPersistenceModel persistenceModel = AutoMap.AssemblyOf<Domain.Entities.User>(new AutomappingConfiguration())
